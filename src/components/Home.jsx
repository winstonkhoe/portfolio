...
const Home = (props) => {
  ...
  return (
    <>
      <section id="tech-stack-container" onMouseDown={(e) => { if(e.target.id === "tech-stack-container") setClickedTech("") }} className="lg:min-h-screen flex justify-center items-center">
        <div className="container">
          <div className="feature-grid-container grid grid--columns">
            <div className="profile-container relative flex h-full justify-center items-center overflow-hidden">
              ...
              >
                <div className="group rounded-full relative flex justify-center items-center z-[999] overflow-hidden h-48 w-48">
                  <img
                    ...
                    alt=""
                  />
                  <h6 className="absolute text-xl opacity-0 transition-all duration-[500ms] group-hover:opacity-100">☕relax</h6>
                </div>
                ...
                <div className="flex large-gap">
                  <a href="https://github.com/winstonkhoe" target={"_blank"}><FaGithub className="w-8 h-8 transition-all hover:opacity-50"/></a>
                  <a href="https://www.instagram.com/winkhoee" target={"_blank"}><FaInstagram className="w-8 h-8 transition-all hover:opacity-50"/></a>
                  <a href="https://www.linkedin.com/in/winston-khoe/" target={"_blank"}><FaLinkedin className="w-8 h-8 transition-all hover:opacity-50"/></a>
                </div>
              </div>
              <div
              ...
              >
                <h2 className="text-2xl font-bold">{hoverTech !== "" ? hoverTech : clickedTech}</h2>
              ...
              {techs.map((tech, index) => {
                return (
                  <TechItem
                    ...
                    click={setClickTech}
                    style={hoverTech === "" && clickedTech === tech.name ? "highlight-shadow" : "" }
                  />
                );
              })}
            </div>
